...
## Lessons
Stress governed for every part, and it ususally wasnt close except for part E. The reaction forces from part C affect parts D and E. Because the bracket was treated as symmetrical, the load was split between both ends. Bad math in C would cascade into affecting D and E 
